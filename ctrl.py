...
photo = tkinter.PhotoImage(file="pics/bg4.png")
bg_label = tkinter.Label(root, image=photo, justify=tkinter.LEFT, compound=tkinter.CENTER)
val = tkinter.StringVar()
host_lab = tkinter.Label(root, text="Host:", bg='#2c5a1c', fg='white')
host_en = tkinter.Entry(root, show=None, font=('Arial', 14), textvariable=val, width=12, bg='#e0ab2a', fg='white')
sca_lab = tkinter.Label(root, text="Scale:", bg='#2c5a1c', fg='white')
sca = tkinter.Scale(root, from_=10, to=100, orient=tkinter.HORIZONTAL, length=100,
                    showvalue=100, resolution=0.1, tickinterval=50, command=SetScale, bg='#e0ab2a', fg='white')
show_btn = tkinter.Button(root, text="Show", command=ShowScreen, bg='#2c5a1c', fg='white')
proxy_btn = tkinter.Button(root, text="Proxy", command=ShowProxy, bg='#2c5a1c', fg='white')
